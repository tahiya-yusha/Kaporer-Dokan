    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3> Edit Products
                    <a href="{{ url('admin/products') }}" class = "btn btn-secondary btn-sm float-end">
                        BACK
                    </a>
                </h3>
            </div>
            ...
            <div class="tab-pane fade border p-3" id="image-tab-pane" role="tabpanel" aria-labelledby="image-tab" tabindex="0">
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                        <img src="{{ asset($image->image) }}" style = "width:160px;height:160px;" class = "me-4 border" alt="Img" />
                            ...
                            <tr class = "prod-color-tr">
                                ...
                                <td>
                                    <div class="input-group mb-3" style="width:150px">
                                        ...
                                        <button type = "button" value = "{{ $prodColor->color_id }}" class = "updateProductColorBtn btn btn-primary btn-sm text-white">Update</button>
                                    </div>
                                </td>
                                <td>
                                    <button type = "button" value = "{{ $prodColor->color_id }}" class ="deleteProductColorBtn btn btn-danger btn-sm text-white">Delete</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
