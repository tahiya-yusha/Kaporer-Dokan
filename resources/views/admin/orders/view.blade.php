...
<div class="row">
    ...
    <div class="card">
            ...
            <div class="card-body">
                ...
                <h4>
                    <a href="{{ url('admin/invoice/'.$order->id.'/generate') }}" class="btn btn-sm btn-dark mx-1">Download Invoice</a>
                    <a href="{{ url('admin/invoice/'.$order->id) }}" target = "_blank" class="btn btn-sm btn-dark mx-1">View Invoice</a>
                    <a href="{{ url('admin/orders') }}" class="btn btn-sm btn-dark mx-1">Back</a>
                    </h4> 
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if($orderItem->product->productImages)
                                        <img src="{{ asset($orderItem->product->productImages[0]->image) }}" style="object-fit: contain; width: 50px; height: 50px" alt="">
                                    @else
                ...
                <div class="row">
                    <div class="col-md-5">
                        <form action="{{ url('admin/orders/'.$order->id) }}" method = "POST">
                            ...
                            <button type = "submit" class="btn" style="color:white; background:black;">Update</button>
                            </div>
                        </form>
                    </div>
                    <div class="col-md-7">
